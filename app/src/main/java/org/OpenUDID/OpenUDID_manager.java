...
public class OpenUDID_manager implements ServiceConnection {
    ...
    public final static String TAG = "org/OpenUDID";
...
//        OpenUDID = Secure.getString(mContext.getContentResolver(), Secure.ANDROID_ID);
    ...
    private void startService() {
        if (mMatchingIntents.size() > 0) { //There are some Intents untested
            ...
            if (OpenUDID == null || OpenUDID.equals("udid")) //No OpenUDID was chosen, generate one
                generateOpenUDID();
    ...
    public static String getOpenUDID() {
        if (!mInitialized) Log.e("org/OpenUDID", "Initialisation isn't done");
        return OpenUDID;
    }
